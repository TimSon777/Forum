...
namespace LiWiMus.Infrastructure.Data.Migrations
{
    ...
    [Migration("20220418165231_AddOpenIdConnect")]
    partial class AddOpenIdConnect
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LiWiMus.Core.UserClaims.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LiWiMus.Core.UserRoles.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LiWiMus.Core.UserRoles.UserRole", b =>
                {
                    b.HasOne("LiWiMus.Core.Roles.Role", "Role")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("LiWiMus.Core.Users.User", b =>
                {
                    b.HasOne("LiWiMus.Core.Artists.Artist", "Artist")
                        .WithOne("User")
                        .HasForeignKey("LiWiMus.Core.Users.User", "ArtistId");
