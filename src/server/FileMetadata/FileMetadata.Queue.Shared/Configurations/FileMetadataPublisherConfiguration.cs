...
public static class FileMetadataPublisherConfiguration
{
    public static IServiceCollection AddFileMetadataPublisher(this IServiceCollection services, IConfiguration configuration)
    {
